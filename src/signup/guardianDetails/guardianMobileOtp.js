...
/**
 * Signup screen to input otp to verify the received guardian mobile number
 */
function GuardianMobileOtp({ setValidator }) {
    ...
    return (
        <div>
            ...
            <h4>OTP for {guardianData.mobile}</h4>
            <OtpVerify {...{ setCallBack }} />
        </div>
    );
}

export default GuardianMobileOtp;
